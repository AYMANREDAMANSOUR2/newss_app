      ...
      body: Padding(
        padding: const EdgeInsets.all(12.0),
            ...
            //-----------------------------------News content --------------------------------------------------------------------
                 ...
                 Text(
              news.content??"no news here",style: TextStyle(
              fontSize: 30
            ...
            //----------------------------------button at end of screen-------------------------------------------------------------------
                ...
                TextButton(onPressed: (){
                  openUrl(news.url?? "loooooooooooooooooooooooooool") ;
                      ...
                      Text('View full Article ',style: TextStyle(fontSize: 25 ,color: Colors.black),) ,
                      Icon(Icons.arrow_circle_right_rounded , size: 30,color: Colors.black,)
            ],))
