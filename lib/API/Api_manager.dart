...
class ApiManger{
    ...
    static Future<SourcesResponse>   getNewsSourses(String catId) async{
      var uri = Uri.https(BASE_URL, "/v2/top-headlines/sources", {"apiKey" : API_KEY , "category" : catId ,}) ;
      var response  = await http.get(uri) ;
      var json = jsonDecode(response.body) ; //convert to json
      SourcesResponse sourcesResponse = SourcesResponse.fromJson(json) ; //convert json to my dataclass (sources) ;
